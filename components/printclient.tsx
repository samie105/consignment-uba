    ...
    const downloadPdf = () => {
      if (receiptRef.current) {
        ...
        const opt = {
          ...
          filename: `Greenroute Delivery-Receipt-${packageData.tracking_number}.pdf`,
        ...
        <div ref={receiptRef} className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="border-t border-b py-4 mb-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold">Greenroute Delivery</h2>
          ...
          <div className="text-center text-sm text-muted-foreground mt-12 pt-4 border-t">
            <p>Thank you for choosing Greenroute Delivery for your shipping needs.</p>
            <p>For any inquiries, please contact support@Greenroute Delivery.com</p>
          </div>

          <div className="mt-8 text-center">
            <div className="inline-block border-t border-dashed w-full pt-2 text-xs text-muted-foreground">
              <p>This is an official receipt from Greenroute Delivery</p>
